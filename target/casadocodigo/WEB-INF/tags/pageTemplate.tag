...
<head>
  ...
  <link rel="alternate" type="application/json+oembed" href="http://www.casadocodigojapa.com.br/products/livro-java8.oembed" />
  ...
  <link rel="canonical" href="http://www.casadocodigojapa.com.br/products/livro-java8" />
</head>
    ...
    $(function() {
      $('a[href^="http"]')
         ...
         .filter(function(index) {
            var ccb = $(this).attr('href').indexOf("casadocodigojapa.com.br");
