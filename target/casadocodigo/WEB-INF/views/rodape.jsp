    ...
    <div class="clearfix container">
      ...
      <div id="social-footer"><!-- books-footer -->
         ...
         <ul class="footer-text-links">
          ...
          <li><a href="http://livros.casadocodigojapa.com.br" rel="nofollow">Meus E-books</a></li>
          <li><a href="/pages/sobre-a-casa-do-codigo">Sobre a Casa do Código</a></li>
          <li><a href="http://suporte.casadocodigojapa.com.br" target="_blank">Perguntas Frequentes</a></li>
          ...
          <li><a href="http://www.casadocodigojapa.com.br/pages/politica-de-privacidade" rel="nofollow">Política de Privacidade</a></li>
         </ul>
      </div>
